...
import com.example.instaappandroidprojectprojectbrain.Adapter.FollowingAdapter;
...
public class FollowingFragment extends Fragment {
    ...
    private ArrayList<Profile1> searchedUsersList;
        ...
        db.collection("users").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                for (QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots) {
                    Profile1 documentProfile = documentSnapshot.toObject(Profile1.class);
                    Log.d("Following Fragment: ", "onSuccess: " + documentProfile.getUsername());
                    searchedUsersList.add(documentProfile);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        searchUsername = view.findViewById(R.id.txtSearchUsernames);
        searchedUsersList = new ArrayList<>();
        adapter = new FollowingAdapter(getActivity(), searchedUsersList, this);
            ...
            public void onClick(View v) {
                db.collection("users").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        for (QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots) {
                            Profile1 documentProfile = documentSnapshot.toObject(Profile1.class);
                            if(documentProfile.getUsername().equals(searchUsername.getText().toString())) {
                                Log.d("Following Fragment: ", "onSuccess: " + documentProfile.getUsername());
        ...
        recyclerHome = view.findViewById(R.id.recyclerUsers);
